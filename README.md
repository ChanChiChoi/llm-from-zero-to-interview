...
1. 第一册 `book-01-core-30/` 已完成正文第一版，共 38 讲。
2. 第二册 `book-02-advanced-100/` 已完成正文第一版，共 120 讲。
3. 第三册 `book-03-practical-handbook/` 已完成正文第一版，共 72 讲。
4. 第四册到第十九册已完成正文第一版，其中第四册定位为后续持续补全的概念索引。
5. 第二十册到第二十四册已完成目录和写作框架，后续逐步扩写。
6. 面试题库、练习体系、论文路线、项目路线、术语表和学习路线图已建立基础版本。
...
第二册也已完成正文第一版，覆盖更细的进阶主题，包括现代 Transformer 变体、长上下文、MoE、SSM/S4/Mamba、Reasoning、Agent、多模态、评估、安全和研究前沿。

第三册已完成正文第一版，目标是把前两册的知识转成代码、实验、项目和面试表达。目前已覆盖 PyTorch 基础、Transformer 组件、miniGPT、Hugging Face 微调、偏好优化、推理优化、RAG 与 Agent、评估 debug、简历项目、面试实战训练和多模态实战。

第五册、第六册和第七册也已完成正文第一版，分别覆盖训练全流程、部署推理工程，以及大模型评估、实验设计、A/B 测试、统计显著性、error analysis 和评估面试题。

第八册到第十九册也已完成正文第一版，分别覆盖 AI Safety 与 Alignment、数据工程、论文复现、系统设计、求职面试、数学基础、PyTorch 工程、多模态、Reasoning、Agent、产品落地和资深工程师实战坑。
...
1. 继续扩写第二十册《Agent Harness、Coding Agent Runtime 与智能体工程框架》。
2. 对第一册到第十九册已完成正文做统一校对、补图、补公式和代码可运行性检查。
3. 按已完成正文同步补充项目路线、练习体系、面试题库和术语表。
4. 逐步扩写第二十册到第二十四册的专题正文。
5. 后期集中完善第四册《大模型百科全书》，把其他各册沉淀出的核心知识点补成可检索的简明条目。
