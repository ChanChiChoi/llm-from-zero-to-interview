...
```text
o_t = Σ attention_weight(t, j) * v_j
```
...
```text
num_layers * batch_size * num_kv_heads * head_dim * 2
```
...
```text
total latency = prefill latency + decode latency
```
